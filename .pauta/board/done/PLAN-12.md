...
- {"kind":"iteration","at":"2026-09-03T11:12:13Z","contract_revision":2,"verification":"zig fmt --check build.zig build.zig.zon src tests examples","result":"Pass — formatting clean across build.zig, build.zig.zon, src, tests, examples.","context":"Session smooth-shark (claude-code), 2026-09-03. Re-run on current main, which is the v0.14.0 tree plus two doc-only commits (9192942 board, 085eba4 SECURITY.md/CHANGELOG retraction).","artifact":"085eba4 (v0.14.0 @ 41b9821 + 2 doc commits)","hypothesis":"The contract verify line passes on the current tree, not just the tagged one.","action":"Ran the contract verify line directly.","next_state":"Recording the remaining 13 verify lines."}
- {"kind":"iteration","at":"2026-09-03T11:12:19Z","contract_revision":2,"verification":"zig build check","result":"Pass — public root compiles.","context":"Session smooth-shark, 2026-09-03, current main.","artifact":"085eba4","hypothesis":"Verify line passes.","action":"Ran the contract verify line (library compile).","next_state":"Remaining verify lines."}
- {"kind":"iteration","at":"2026-09-03T11:12:22Z","contract_revision":2,"verification":"zig build test --summary all","result":"Pass — 228/228 tests, 3/3 build steps, zero leaks.","context":"Session smooth-shark, 2026-09-03, current main.","artifact":"085eba4","hypothesis":"Verify line passes.","action":"Ran the contract verify line (unit suite).","next_state":"Remaining verify lines."}
- {"kind":"iteration","at":"2026-09-03T11:12:24Z","contract_revision":2,"verification":"zig build examples","result":"Pass — examples compile; yq_lite demo ran, wrote zig-out/yq-lite-demo.yaml with edits applied and untouched bytes preserved, schema $.dogfood valid.","context":"Session smooth-shark, 2026-09-03, current main.","artifact":"085eba4","hypothesis":"Verify line passes.","action":"Ran the contract verify line (examples build and run).","next_state":"Remaining verify lines."}
- {"kind":"iteration","at":"2026-09-03T11:12:31Z","contract_revision":2,"verification":"zig build conformance --summary all","result":"Pass — conformance: 351 pass, 0 fail, 0 skip, 0 stale. Pinned baseline held exactly.","context":"Session smooth-shark, 2026-09-03, current main. Re-run with exit status captured separately after a grep pattern in the first run matched an unrelated line.","artifact":"085eba4","hypothesis":"Verify line passes and the pinned baseline is unmoved by the doc commits.","action":"Ran the contract verify line (corpus conformance); confirmed exit=0 explicitly.","next_state":"Remaining verify lines."}
- {"kind":"iteration","at":"2026-09-03T11:12:34Z","contract_revision":2,"verification":"zig build roundtrip --summary all","result":"Pass — roundtrip: 265 pass, 0 fail, 4 skip. Pinned baseline held exactly.","context":"Session smooth-shark, 2026-09-03, current main. Exit status confirmed separately.","artifact":"085eba4","hypothesis":"Verify line passes and the pinned baseline is unmoved.","action":"Ran the contract verify line (byte-faithful round trip); confirmed exit=0 explicitly.","next_state":"Remaining verify lines."}
- {"kind":"iteration","at":"2026-09-03T11:12:37Z","contract_revision":2,"verification":"zig build preservation --summary all","result":"Pass — 9/9 tests, zero failures across fixtures, corpus and variants.","context":"Session smooth-shark, 2026-09-03, current main.","artifact":"085eba4","hypothesis":"Verify line passes; comment sweeps still green.","action":"Ran the contract verify line (edit preservation incl. comment sweeps).","next_state":"Remaining verify lines."}
- {"kind":"iteration","at":"2026-09-03T11:12:43Z","contract_revision":2,"verification":"sh scripts/consumer-smoke.sh","result":"Pass (exit 0) — \"consumer ok: parsed, edited and re-emitted byte-faithfully\".","context":"Session smooth-shark, 2026-09-03, current main.","artifact":"085eba4","hypothesis":"Verify line passes.","action":"Ran the contract verify line (packaged consumer smoke).","next_state":"Remaining verify lines."}
- {"kind":"iteration","at":"2026-09-03T11:12:46Z","contract_revision":2,"verification":"sh scripts/differential.sh","result":"Pass (exit 0) — 269 compared, 0 mismatches, 82 not comparable (fail-flagged). Above the >=250 floor.","context":"Session smooth-shark, 2026-09-03, current main, against the vendored libfyaml.","artifact":"085eba4","hypothesis":"Verify line passes and clears the >=250-compared non-vacuity floor.","action":"Ran the contract verify line (libfyaml differential).","next_state":"Remaining artifact-presence lines."}
- {"kind":"iteration","at":"2026-09-03T11:12:49Z","contract_revision":2,"verification":"test -f SECURITY.md","result":"Pass.","context":"Session smooth-shark, 2026-09-03. SECURITY.md was edited today by 085eba4 to retract the false programmatic-depth bound; it still exists and still documents the bounds list.","artifact":"085eba4","hypothesis":"Verify line passes.","action":"Ran the contract verify line (SECURITY.md present).","next_state":"Remaining verify lines."}
- {"kind":"iteration","at":"2026-09-03T11:12:55Z","contract_revision":2,"verification":"test -f docs/design/comments.md","result":"Pass.","context":"Session smooth-shark, 2026-09-03, current main.","artifact":"085eba4","hypothesis":"Verify line passes.","action":"Ran the contract verify line (design doc present).","next_state":"Remaining verify lines."}
- {"kind":"iteration","at":"2026-09-03T11:12:59Z","contract_revision":2,"verification":"grep -qi 'comment' docs/USAGE.md","result":"Pass — the \"Comments: read and write\" section is present.","context":"Session smooth-shark, 2026-09-03, current main.","artifact":"085eba4","hypothesis":"Verify line passes.","action":"Ran the contract verify line (USAGE documents comments).","next_state":"Remaining verify lines."}
- {"kind":"iteration","at":"2026-09-03T11:13:01Z","contract_revision":2,"verification":"grep -q '0.14.0' build.zig.zon","result":"Pass — .version is still 0.14.0.","context":"Session smooth-shark, 2026-09-03, current main. The doc commits did not touch build.zig.zon.","artifact":"085eba4","hypothesis":"Verify line passes.","action":"Ran the contract verify line (package version).","next_state":"One verify line left."}
- {"kind":"iteration","at":"2026-09-03T11:13:06Z","contract_revision":2,"verification":"grep -q 'v0.14.0' README.md","result":"Pass — both install pins read #v0.14.0.","context":"Session smooth-shark, 2026-09-03, current main. Final contract verify line; the doc commits did not touch README.md.","artifact":"085eba4","hypothesis":"Verify line passes.","action":"Ran the contract verify line (README install pins).","next_state":"All 14 contract verify lines re-run and recorded on the current tree; submitting for review."}
- {"kind":"controller_verification","at":"2026-09-03T11:38:02Z","contract_revision":2,"verification":"zig fmt --check build.zig build.zig.zon src tests examples","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:02Z","ended_at":"2026-09-03T11:38:02Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:08Z","contract_revision":2,"verification":"zig build check","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:08Z","ended_at":"2026-09-03T11:38:08Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:08Z","contract_revision":2,"verification":"zig build test --summary all","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:08Z","ended_at":"2026-09-03T11:38:08Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:08Z","contract_revision":2,"verification":"zig build examples","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:08Z","ended_at":"2026-09-03T11:38:08Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:08Z","contract_revision":2,"verification":"zig build conformance --summary all","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:08Z","ended_at":"2026-09-03T11:38:08Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:09Z","contract_revision":2,"verification":"zig build roundtrip --summary all","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:09Z","ended_at":"2026-09-03T11:38:09Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:09Z","contract_revision":2,"verification":"zig build preservation --summary all","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:09Z","ended_at":"2026-09-03T11:38:09Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:09Z","contract_revision":2,"verification":"sh scripts/consumer-smoke.sh","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:09Z","ended_at":"2026-09-03T11:38:09Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:09Z","contract_revision":2,"verification":"sh scripts/differential.sh","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:09Z","ended_at":"2026-09-03T11:38:09Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:09Z","contract_revision":2,"verification":"test -f SECURITY.md","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:09Z","ended_at":"2026-09-03T11:38:09Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:09Z","contract_revision":2,"verification":"test -f docs/design/comments.md","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:09Z","ended_at":"2026-09-03T11:38:09Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:09Z","contract_revision":2,"verification":"grep -qi 'comment' docs/USAGE.md","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:09Z","ended_at":"2026-09-03T11:38:09Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:09Z","contract_revision":2,"verification":"grep -q '0.14.0' build.zig.zon","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:09Z","ended_at":"2026-09-03T11:38:09Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
- {"kind":"controller_verification","at":"2026-09-03T11:38:10Z","contract_revision":2,"verification":"grep -q 'v0.14.0' README.md","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-09-03T11:38:10Z","ended_at":"2026-09-03T11:38:10Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:gilberto","reason":"human directed 2026-09-03; check re-run green on 085eba4 by session smooth-shark"}
...
- 2026-09-03T11:01:46Z 2026-09-03 — smooth-shark (claude-code) — **Disposition of the recovered suspicions, decided by the human today: patch the doc now, defer the code fix.**

Done in this session:
- `085eba4 docs(security): retract a bound that does not exist` — SECURITY.md's claim that a deep programmatic tree is "bounded only by the emitter's depth limit" and that the caller "gets an error, not a half-built result" is retracted and replaced by a Known gap paragraph carrying the measured numbers. CHANGELOG gains an Unreleased entry. This is a retraction, not a fix.
- **PLAN-13** created in backlog with both residuals: (A) depth-bound `value.convert` and `schema.checkSchema` with a typed error, settle the schema path either way; (B) close the scanner/parser allocation-sweep gap with inputs that reach anchors, aliases, tags, flow collections and block scalars.
- `9192942` — the board lane move b8457fb left half-done: it committed `in-progress/PLAN-12.md` but never the staged deletion of `backlog/PLAN-12.md`, so HEAD carried this card in two lanes at once. Committed together; the board is single-valued again.

**Why this card can still be accepted.** Its C done_when asks that each suspicion be "individually reproduced-and-fixed or cleared-with-evidence". Suspicion 1 was reproduced and fixed. Suspicions 2 and 3 are now, for the first time, recovered and evidenced — 2 reproduced at runtime, 3 measured as half-closed — and both are tracked in PLAN-13 rather than dropped. v0.14.0 shipped what it said it shipped; the residual is a pre-existing defect this card surfaced rather than introduced. Submitting for review on that basis. Accepting to done remains the human's call.

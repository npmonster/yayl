...
- {"kind":"controller_verification","at":"2026-08-30T12:04:11Z","contract_revision":1,"verification":"zig fmt --check build.zig build.zig.zon src tests examples","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:11Z","ended_at":"2026-08-30T12:04:11Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger (Claude Code, on user instruction)","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30: exit 0. Board UI activation is broken for the user, who asked this session to close the card via CLI."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:19Z","contract_revision":1,"verification":"zig build check","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:19Z","ended_at":"2026-08-30T12:04:19Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger (Claude Code, on user instruction)","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: exit 0."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:19Z","contract_revision":1,"verification":"zig build test --summary all","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:19Z","ended_at":"2026-08-30T12:04:19Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger (Claude Code, on user instruction)","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: 177/177 pass, zero leaks."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:19Z","contract_revision":1,"verification":"zig build test -Doptimize=ReleaseSafe --summary all","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:19Z","ended_at":"2026-08-30T12:04:19Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger (Claude Code, on user instruction)","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: 177/177 pass."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:19Z","contract_revision":1,"verification":"grep -qi 'agent' README.md","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:19Z","ended_at":"2026-08-30T12:04:19Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger (Claude Code, on user instruction)","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: pass, README carries the AI development disclosure section."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:19Z","contract_revision":1,"verification":"test -f CHANGELOG.md","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:19Z","ended_at":"2026-08-30T12:04:19Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger (Claude Code, on user instruction)","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: pass."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:20Z","contract_revision":1,"verification":"test -f CONTRIBUTING.md","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:20Z","ended_at":"2026-08-30T12:04:20Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger (Claude Code, on user instruction)","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: pass."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:20Z","contract_revision":1,"verification":"test -d examples","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:20Z","ended_at":"2026-08-30T12:04:20Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger (Claude Code, on user instruction)","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: pass."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:26Z","contract_revision":1,"verification":"zig build check","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:26Z","ended_at":"2026-08-30T12:04:26Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger-claude-code-on-user-instruction","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: exit 0."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:27Z","contract_revision":1,"verification":"zig build test --summary all","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:27Z","ended_at":"2026-08-30T12:04:27Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger-claude-code-on-user-instruction","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: 177/177 pass, zero leaks."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:27Z","contract_revision":1,"verification":"zig build test -Doptimize=ReleaseSafe --summary all","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:27Z","ended_at":"2026-08-30T12:04:27Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger-claude-code-on-user-instruction","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: 177/177 pass."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:27Z","contract_revision":1,"verification":"grep -qi 'agent' README.md","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:27Z","ended_at":"2026-08-30T12:04:27Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger-claude-code-on-user-instruction","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: pass, README carries the AI development disclosure."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:27Z","contract_revision":1,"verification":"test -f CHANGELOG.md","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:27Z","ended_at":"2026-08-30T12:04:27Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger-claude-code-on-user-instruction","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: pass."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:27Z","contract_revision":1,"verification":"test -f CONTRIBUTING.md","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:27Z","ended_at":"2026-08-30T12:04:27Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger-claude-code-on-user-instruction","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: pass."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:27Z","contract_revision":1,"verification":"test -d examples","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:27Z","ended_at":"2026-08-30T12:04:27Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger-claude-code-on-user-instruction","reason":"Re-run on a clean detached worktree of origin/main b56d64f 2026-08-30 by wise-tiger; board UI activation broken, user asked this session to close the card via CLI. Result: pass."}
- {"kind":"controller_verification","at":"2026-08-30T12:04:37Z","contract_revision":1,"verification":"grep -q '0.9.0' build.zig.zon","verification_id":"","result":"passed","exit_code":0,"command":"","shell":"","workspace_fingerprint":"","artifact":"","artifact_sha256":"","started_at":"2026-08-30T12:04:37Z","ended_at":"2026-08-30T12:04:37Z","environment":"","isolation":"none: recorded by a human, not run by the controller","detail":"","excerpt":"","excerpt_truncated":false,"run_id":0,"cycle":0,"attempt":0,"issuer":"human:wise-tiger-claude-code-on-user-instruction","reason":"SUPERSEDED, NOT PASSING. This check FAILS on current main: build.zig.zon now reads .version = 0.10.0. It failed because the card's objective was met and then exceeded. v0.9.0 was tagged and released from 6c36a2e on 2026-08-30 with .version = 0.9.0, satisfying this check at the time; v0.10.0 was then tagged from 98ecc83 after twelve edit-preservation defects, a value-ownership repair and a core-schema resolver fix were found and fixed. Both tags are on origin and immutable. The criterion is therefore obsolete rather than unmet, and re-pointing the version backwards to satisfy a literal grep would be wrong. Attested by wise-tiger on user instruction after the board UI could not activate the card."}
...
- 2026-08-30T12:04:59Z 2026-08-30 closeout by wise-tiger (Claude Code) on user instruction; board UI could not activate the card, so this was done via CLI.

RE-VERIFIED on a clean detached worktree of origin/main b56d64f (not the shared working tree, which carries four other sessions' in-flight work): fmt clean, zig build check green, 177/177 Debug zero leaks, 177/177 ReleaseSafe, CHANGELOG/CONTRIBUTING/examples present, README carries the AI-development disclosure. 8 of 9 declared checks pass.

ONE CRITERION SUPERSEDED, recorded as such rather than as a pass: 'build.zig.zon version is 0.9.0' now FAILS because the version reads 0.10.0. v0.9.0 was tagged and released from 6c36a2e, satisfying the card; v0.10.0 followed from 98ecc83. Both tags are on origin and immutable.

CORRECTION TO THE ROUND-2 REVIEW, which recorded a PASS this card did not earn on one point. The criterion 'CI runs roundtrip + differential and fails on zero-case vacuous runs' was recorded done, but the differential gate had NEVER run in CI. vendor/libfyaml was never fetched there, so the step failed on every push since it was added. Both the worker and the independent reviewer verified by running 'make differential' LOCALLY, where a hand-placed vendor/libfyaml checkout existed, so neither saw it. Three stacked defects were behind it, all fixed on 2026-08-30: no fetch script for the pinned libfyaml (db01fcf), a missing -lm so the reference failed to link on glibc while linking fine on macOS (a0fe5c6), and 'zig build dump' depending on the compile step rather than the install step so zig-out/bin/dump never existed on a clean checkout (db9874d). That last one is why it passed locally: a stale binary from an earlier plain 'zig build'. The criterion is genuinely met now and CI is green on all six jobs.

ALSO SINCE THE CARD WAS WRITTEN: CI now runs the portable gates on macOS, Windows and arm64 Linux (8b173c5, 2532b22); a consumer smoke test builds a throwaway package against the checkout to catch a .paths omission (99a8ab8); a tag-version-match job hard-fails a tag disagreeing with build.zig.zon; the round-trip gate's glob was only '*.yaml', silently excluding four .yml fixtures, 366 of 776 fixture lines (1294e98); and an edit-preservation sweep now runs in verify and CI (9095205, 34c5bbf) — the gate whose absence let twelve defects ship in v0.9.0.

TIDY STATE: single branch main, remote tags v0.9.0 and v0.10.0 only, local-only wip-safety-snapshot tag deleted, stage1-block-emission branch merged and gone. One detached worktree remains under peer session misty-wolf's scratchpad at 98ecc83; it belongs to a live session doing post-0.10.0 work, not leftover residue from this card, and removing another session's worktree is theirs to do. Follow-up coverage work is tracked as PLAN-11.
